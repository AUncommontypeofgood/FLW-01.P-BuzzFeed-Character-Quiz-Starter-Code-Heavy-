...
Make sure to check off your items as you complete them. [x] → [x]
...
10. [x] Create a conditional statement for the
responses to Question 4 based on the user input.
